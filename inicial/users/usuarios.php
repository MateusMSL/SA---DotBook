...
<html lang="en">
  <head>
    ...
    <link href="views/inicial/pagina-inicial_logado.css" rel="stylesheet">
  ...
  <body>
    ...
    <header class="col-lg-12 col-sm-12"> <!-- Cabeçalho -->
        ...
        <p> <font color="white"> Bem Vindo, </font> <font color="orange">' . $usuario->getNome() . ' </font> </p>
        </nav>
        <nav id="logoff" class="col-lg-1 col-sm-2"> <!-- Login --> 
            <button type="button" class="btn btn-outline-light"  onclick="deslogar()"> Logout </button></button>
        </nav>
    </header>
...
<div class="container-fluid" id="alert_book" data-aos="zoom-in"> 
